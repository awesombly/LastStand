...
public:
	static void BroadCast( const PACKET& _packet, const std::unordered_map<SOCKET, Session*>& _sessions, bool _includeOneself );
	void BroadCast( const PACKET& _packet, bool _includeOneself = false ) const;
